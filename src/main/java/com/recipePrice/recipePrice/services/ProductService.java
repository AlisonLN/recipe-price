...
public class ProductService {
    ...
    public ProductResponse getProductByName(String name) {
        System.out.println("Iniciando Metodo Para Fazer Busca no Banco de Dados Por Nome");
            Optional<Product> products = productRepository.findByName(name);
            System.out.println("Nome encontrado no banco de dados : " + products);
            ProductResponse productResponse2 = products.map(products2 -> new ProductResponse(products2.getId(), products2.getName(), products2.getUnitOfMeasurement(), products2.getPrice())).get();
            System.out.println("Objeto retirado do banco de dados : " + productResponse2);
